...
- **16 site recipes** updated with real RSS feeds, `description` metadata, shared `remove_tags` blocks, `extra_css`, and `publication_type` annotations.
...
- Initial commit: project scaffold, 16 Calibre `.recipe` stubs, orchestrator (`main.py` + `utils.py`), basic test suite, `CATALOG.md` subject taxonomy.
